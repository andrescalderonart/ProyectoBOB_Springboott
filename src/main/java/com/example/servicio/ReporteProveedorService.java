...
public class ReporteProveedorService {
    ...
    public byte[] generarReporteProveedores() {
        ...
        try {
            ...
            table.setWidths(new float[]{1.4f, 1.2f, 1.0f, 1.2f, 1.2f});
            ...
            for (Proveedor p : proveedores) {
                String nom = (p.getIndividuo() != null)
                        ? (nullToDash(p.getIndividuo().getNombre()) + " " +
                        nullToDash(p.getIndividuo().getApellido()))
                        : "—";
